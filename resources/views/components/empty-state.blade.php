<div  class="flex items-center justify-center py-10">
    <div class="grid gap-4 w-60">
        <svg class="mx-auto" xmlns="http://www.w3.org/2000/svg" width="168" height="164" viewBox="0 0 168 164"
            fill="none">
            ...
            <ellipse cx="1.42857" cy="1.42857" rx="1.42857" ry="1.42857"
                transform="matrix(-1 0 0 1 46.8571 31)" fill="#4F46E5" />
            <ellipse cx="1.42857" cy="1.42857" rx="1.42857" ry="1.42857"
                transform="matrix(-1 0 0 1 38.2859 31)" fill="#4F46E5" />
            <ellipse cx="1.42857" cy="1.42857" rx="1.42857" ry="1.42857"
                transform="matrix(-1 0 0 1 29.7141 31)" fill="#4F46E5" />
            <path
        ...
        <div>
            <h2 class="text-center text-black text-xl font-semibold leading-loose pb-2">{{$title}}</h2>
            <p class="text-center text-black text-base font-normal leading-relaxed pb-4">{{$subTitle}}</p>
